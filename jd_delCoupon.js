...
function isJDCoupon(title) {
  if (title.indexOf('京东') > -1)
    ...
    return true
  else if (title.indexOf('电脑数码') > -1)
    return true
  else if (title.indexOf('电脑办公') > -1)
    return true
  else if (title.indexOf('电脑配件') > -1)
    return true
  else if (title.indexOf('自营文具') > -1)
    return true
  else if (title.indexOf('自营图书') > -1)
    return true
  else if (title.indexOf('自营手机') > -1)
    return true
  else if (title.indexOf('食品饮料') > -1)
    return true
  else if (title.indexOf('食品酒水') > -1)
    return true
  else if (title.indexOf('调味干货') > -1)
    return true
  else if (title.indexOf('牛奶') > -1)
    return true
  else if (title.indexOf('米面') > -1)
    return true
  else if (title.indexOf('杂粮') > -1)
    return true
  else if (title.indexOf('PLUS') > -1)
    return true
